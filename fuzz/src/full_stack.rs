...
fn two_peer_forwarding_seed() -> Vec<u8> {
	...
	// config
	ext_from_hex("00000000009000000000000000006464000100000000000100ffff00000000000000ffffffffffffffffff0000000000000000ffffffffffffffff000000ffffffff00ffff1a000400010000020400000000040200000a08ffffffffffffffff0001000000000000", &mut test);
